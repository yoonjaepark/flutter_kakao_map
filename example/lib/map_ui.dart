...
class MapUiBodyState extends State<MapUiBody> {
  ...
  static final CameraPosition _kInitialPosition = const CameraPosition(
    target: MapPoint(-33.852, 151.211),
    zoom: 11.0,
  );
  ...
  CurrentLocationTrackingMode _currentLocationTrackingMode = CurrentLocationTrackingMode.trackingModeOff;
  ...
  Widget _currentLocationTrackingModeCycler() {
    final CurrentLocationTrackingMode nextType =
        CurrentLocationTrackingMode.values[(_currentLocationTrackingMode.index + 1) % CurrentLocationTrackingMode.values.length];
    return FlatButton(
      child: Text('change map type to $nextType'),
      onPressed: () {
        setState(() {
