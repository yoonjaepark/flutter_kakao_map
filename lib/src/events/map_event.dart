...
///
/// (See [MethodChannelKakaoMapsFlutter.onCameraMoveStarted], for example)
///
...
class MarkerSelectEvent extends MapEvent<MarkerTag> {
  /// Build a MarkerTap Event triggered from the map represented by `mapId`.
  ///
  /// The `value` of this event is a [String] object that represents the tapped Marker.
  MarkerSelectEvent(int mapId, MarkerTag markerId) : super(mapId, markerId);
}
